...
## Cài mysql và phpmyadmin bằng script <a id="extra"></a>
...
Portainer là công cụ dùng để quản lý các docker apps và thao tác chúng được thuận tiện hơn trên giao diện người dùng.
